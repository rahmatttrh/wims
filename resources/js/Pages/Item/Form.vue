        ...
        <div class="flex flex-col gap-6">
          <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex flex-col gap-6 w-full lg:w-1/2">
              ...
              <auto-complete json id="unit" :label="$t('Unit')" :suggestions="units" v-model="form.unit_id" />
              ...
              <div class="flex items-end">
                <div v-if="edit?.photo" class="w-16 h-16 mr-4 relative group">
                  <button
                    type="button"
                    @click="() => (photo = true)"
                    class="hidden group-hover:flex items-center rounded-sm justify-center absolute inset-1 bg-gray-900/80"
                  >
                    <icons name="trash" class="shrink-0 w-6 h-6 text-red-500" />
                  </button>
                  <img :src="edit.photo" alt="" class="rounded-sm w-16 h-16" />
                </div>
                <div class="flex-1">
            ...
            <div v-if="form.has_variants == 1" class="my-6">
              <div class="flex items-center justify-between">
                ...
                <div>
                  <button
                    ...
                    class="text-gray-100 px-4 py-3 bg-blue-600 border border-blue-600 rounded-l-md ml-4 focus:outline-hidden hover:bg-blue-700"
                  >
                  ...
                  <button
                    ...
                    class="text-gray-100 px-4 py-3 bg-blue-600 border border-blue-600 rounded-r-md focus:outline-hidden hover:bg-blue-700"
                  >
                    <span class="flex items-center justify-center text-lg w-4 h-4">-</span>
                  </button>
                </div>
              ...
              <div class="flex flex-wrap items-start -mx-3">
                <div v-for="(variant, vi) in form.variants" :key="vi" class="mt-6 px-3 w-full lg:w-1/2">
                  <div class="p-4 bg-gray-100 shadow-sm rounded-md">
                    <div class="flex items-start">
                      ...
                      <span class="mt-6">
                        <button
                          ...
                          class="mt-1 text-gray-100 px-4 py-3 bg-gray-600 border border-gray-600 rounded-l-md ml-4 focus:outline-hidden hover:bg-gray-500"
                        >
                          <span class="flex items-center justify-center text-lg w-4 h-4">+</span>
                        </button>
                        <button
                          ...
                          class="mt-1 text-gray-100 px-4 py-3 bg-gray-600 border border-gray-600 rounded-r-md focus:outline-hidden hover:bg-gray-500"
                        >
                          <span class="flex items-center justify-center text-lg w-4 h-4">-</span>
                        </button>
                      </span>
        ...
        <div class="w-full flex items-center justify-between">
          ...
          <div class="flex items-center">
            <!-- <Link
              ...
              class="hidden md:inline px-4 py-2 rounded-sm border-2 border-transparent hover:border-gray-300 focus:outline-hidden focus:border-gray-300"
            >
              {{ $t('Go to Listing') }}
            </Link> -->
