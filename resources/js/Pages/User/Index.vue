    ...
    <div class="px-4 md:px-0">
      ...
      <div class="mb-6 flex justify-between items-center print:hidden">
        <search-filter v-model="form.search" class="w-full max-w-md mr-4" @reset="reset">
          ...
          <select-input v-model="form.role" class="mt-1 w-full">
      ...
      <div class="bg-white -mx-4 md:mx-0 md:rounded-md shadow-sm overflow-x-auto">
        <table class="w-full whitespace-nowrap">
          ...
          <tbody>
            ...
            >
              <td class="border-t">
                <div class="focus:outline-hidden px-6 py-4 flex items-center focus:text-indigo-500">
              ...
              <td class="border-t">
                <div class="focus:outline-hidden px-6 py-4 flex items-center">
                  {{ user.roles ? user.roles.map(r => r.name || r).join(', ') : '' }}
                </div>
              </td>
              <td class="border-t w-px">
                <div class="focus:outline-hidden px-4 flex items-center" v-if="$can('update-users')">
