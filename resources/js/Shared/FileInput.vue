  ...
  <div>
    ...
    <div class="mt-1 relative rounded-md">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center">
        <button
          ...
          @click="remove"
          v-if="modelValue"
          class="px-4 py-2 bg-red-500 hover:bg-red-700 focus:outline-hidden rounded-r-md font-medium text-white flex items-center"
        >
        ...
        <button
          ...
          type="button"
          @click="browse"
          class="px-4 py-2 bg-gray-600 hover:bg-gray-800 focus:outline-hidden rounded-r-md font-medium text-white flex items-center"
        >
    ...
    <!-- <div class="form-input p-0" :class="{ error: errors.length }">
      <div v-if="!value" class="p-2">
        <button type="button" class="px-4 py-1 bg-gray-500 hover:bg-gray-700 rounded-xs text-xs font-medium text-white" @click="browse">
          Browse
        </button>
      </div>
      <div v-else class="flex items-center justify-between p-2">
        ...
        <button type="button" class="px-4 py-1 bg-gray-500 hover:bg-gray-700 rounded-xs text-xs font-medium text-white" @click="remove">
          Remove
        </button>
      </div>
    </div> -->
