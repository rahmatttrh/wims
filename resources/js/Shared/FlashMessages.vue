  ...
  <div class="relative z-30">
    ...
    >
      <div
        ...
        class="fixed top-4 right-4 w-full max-w-xs mb-8 ml-4 flex items-center justify-between bg-green-500 rounded-sm text-white cursor-pointer"
      >
    ...
    >
      <div
        ...
        class="fixed top-4 right-4 w-full max-w-xs mb-8 ml-4 flex items-center justify-between bg-red-500 rounded-sm text-white cursor-pointer"
      >
