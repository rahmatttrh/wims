<template>
  <div class="col-span-6 sm:col-span-4">
    ...
    <div class="relative mt-1 mb-2">
      <label :for="id" name="chevron-down" class="cursor-pointer absolute top-0 right-0 border border-transparent p-2 text-gray-500">
      ...
      <button
        ...
        class="cursor-pointer focus:outline-hidden absolute top-0 right-8 border border-transparent p-2 text-gray-500 hover:text-red-500"
      >
      ...
      <input
        ...
        class="w-full block text-base py-2 pl-4 placeholder-gray-400 border border-gray-300 focus:outline-hidden focus:border-indigo-300 focus:ring-3 focus:ring-indigo-200/50 rounded-md shadow-sm"
      />
      <div v-if="open" :class="position" class="absolute mt-2 w-full rounded-md z-20">
        <ul class="max-h-56 rounded-md bg-white shadow-lg text-base overflow-auto focus:outline-hidden sm:text-sm">
...
export default {
  ...
  methods: {
    getSuggestions: debounce(async function (search) {
